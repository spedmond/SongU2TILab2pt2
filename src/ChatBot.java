public class ChatBot {
    ...
    //method that prints favorite pet name
    public void petName(String petName) {
        System.out.println("Your pet\'s name is " + petName + "? Cool! My pet's name is Julio, and he's a dog!");
    }

    //method that prints height
    public String height(int heightInches) {
        int heightFeet = heightInches/12;
        int remainingHeight = heightInches - (heightFeet*12);
        return heightFeet + "\'" + remainingHeight + "\"";
    }
}